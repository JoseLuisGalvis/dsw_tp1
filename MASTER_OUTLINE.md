...
- **Pasos:**
  ...
  2. En `css/styles.css`, configurar:
     ...
     - Importación de fuentes de Google Fonts (`Roboto` o `Inter` para texto general, y `JetBrains Mono` para detalles técnicos).
     - Estilo Tecnológico: Fondos oscuros, texto blanco claro, recuadros con bordes de colores (Sky Blue/Emerald), esquinas rectas (90º) o con radio muy pequeño (2px a 4px), y cursor estándar del sistema (sin efectos).
